...
func (l *Lexer) Lex(lval *yySymType) int {
	...
	l.lit = lit
	l.pos = pos
	//l.deblog = &WatchLog{Message: fmt.Sprintf("%s", "edwin is here"), Pos: pos, Fatal: true}
	return tok
}
...
func Parse(w http.ResponseWriter, r *http.Request, s *Scanner) ([]ast.Stmt, error) {
